...
/* Клининговый центр
Клининговый центр
2. Реализовать метод cleanAllApartaments.
...
public class Solution
{
    ...
    {
        for (Apartament aparts : apartaments) {
            if (aparts instanceof Apt1Room)
                ((Apt1Room) aparts).clean1Room();
            else if (aparts instanceof Apt2Room)
                ((Apt2Room) aparts).clean2Rooms();
            else if (aparts instanceof Apt3Room)
                ((Apt3Room) aparts).clean3Rooms();
        }
    }
