...
/* Исправление ошибок
2. Подумать, как связаны интерфейсы Swimable(способен плавать) и Walkable(способен ходить) с классом OceanAnimal(животное океана).
...
*/
    ...
    static interface Walkable {void walk();}

    static interface Swimable {void swim();}
